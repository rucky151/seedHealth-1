...
#'
#'
#' @param pHSinit the initial proportion of healthy seed, numeric or numeric
#'   vector.
#' @param Kx the total number of plants, positive interger, numeric or numeric
#'   vector.
#' @param betax the maximum seasonal transmission rate, numeric or numeric
#'   vector.
#' @param wxtnormm the environmental effect on transmission rate (mean of
#'   underlying normal distribution prior to truncation), numeric or numeric
#'   vector.
#' @param wxtnormsd the environmental effect on transmission rate (standard
...
#' @param mxtnormm the vector management effect on transmission rate (mean of
#'   underlying normal distribution prior to truncation), numeric or numeric
#'   vector.
#' @param mxtnormsd the vector management effect on transmission rate (standard
#'   deviation of underlying normal distribution prior to truncation), numeric
#'   or numeric vector.
#' @param axtnormm the roguing effect in terms of decreased DP (mean of
#'   underlying normal distribution prior to truncation), numeric or numeric
#'   vector.
#' @param axtnormsd the roguing effect in terms of decreased DP (standard
#'   deviation of underlying normal distribution prior to truncation), numeric
#'   or numeric vector.
#' @param rx the reversion rate, numeric or numeric vector.
#' @param zxtnormm the proportional selection against diseased plants (mean of
#'   underlying normal distribution prior to truncation), numeric or numeric
#'   vector.
#' @param zxtnormsd the proportional selection against diseased plants (standard
#'   deviation of underlying normal distribution prior to truncation), numeric
#'   or numeric vector.
#' @param gx the seed production rate in healthy plants, numeric or numeric
#'   vector.
#' @param cx the proportional seed production rate in diseased plants, numeric
#'   or numeric vector.
...
#' @param HPcut the proportion healthy plant number cutoff, numeric or numeric
#'   vector.
#' @param pHScut the proportion healthy seed cutoff, numeric or numeric vector.
#' @param maY the maximum attainable yield, end of season, in the absence of
#'   disease, numeric or numeric vector.
#' @param miY the minimum yield when all plants are diseased (useable yield
#'   despite disease), numeric or numeric vector.
#' @param thetax the rate of decline of Yld with increasing disease incidence,
#'   numeric or numeric vector.
#' @param Ex the amount of external inoculum around field, numeric or numeric
#'   vector.
...
onesim <- function(pHSinit = 0.8, Kx = 100, betax = 0.02, wxtnormm = 0.8, 
  ...
  pHSpseas <- length(outm$season[2 : nseasons][which(outm$pHS < pHScut)]) / 
    (nseasons + 1)
